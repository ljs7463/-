...
본 프로젝트는 윈도우 cmd 를 이용해서 사용했으며 c언어로 되어있는 darknet환경을 어떻게 파이썬 코드로 변환해석할지 연구하고 있다.

네이버 블로그에 관련해서 포스팅 같이 올라갑니다. 
https://blog.naver.com/ljs7463/222140569357  <-- 네이버 블로그 주소
